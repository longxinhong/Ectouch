...
?>
    <tr>
        ...
        <td>
            ...
            <a href="drp.php?act=user_edit&id=<?php echo $this->_var['li']['id']; ?>" title="<?php echo $this->_var['lang']['edit']; ?>"><img src="images/icon_edit.gif" border="0" height="16" width="16" /></a>
