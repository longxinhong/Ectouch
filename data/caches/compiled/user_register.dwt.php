          ...
          <ul>
            <li>
              <div class="input-text"><b><?php echo $this->_var['lang']['mobile']; ?>：</b><span>
                <input placeholder="<?php echo $this->_var['lang']['no_mobile']; ?>" name="mobile" id="mobile_phone" type="text" datatype="m">
                </span></div>
            </li>
            <li>
            ...
            <li>
              <div class="input-text"><b><?php echo $this->_var['lang']['password']; ?>：</b><span>
                <input placeholder="<?php echo $this->_var['lang']['password']; ?>" name="password" type="password" datatype="*6-16">
                </span></div>
            </li>
            <li>
              <div class="input-text"><b><?php echo $this->_var['lang']['confirm_password']; ?>：</b><span>
                <input placeholder="<?php echo $this->_var['lang']['confirm_password']; ?>" name="repassword" type="password" datatype="*" recheck="password">
                </span></div>
            </li>
          </ul>
        </div>
